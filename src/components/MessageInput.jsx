...
function MessageInput(
  ...
  const handleMofCancel = () => {
    ...
    // Cambiar de vuelta a consolidadoFacultades
    // Asumiendo que tienes una función para cambiar el selectedAgentId
    // Si no la tienes, necesitarás pasarla como prop
            ...
            {formOptions.map((option) => {
              ...
              return (
                <button
                  ...
                  className="relative p-4 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 hover:border-light-secondary dark:hover:border-dark-secondary transition-all group max-h-14 bg-green-500"
                  disabled={loading}
                >
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center group-hover:bg-light-secondary/10">
                      <Upload
                        size={20}
